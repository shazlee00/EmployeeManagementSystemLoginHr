...
namespace EmployeeManagementSystemLoginHr.Dtos
{
    public class UpdateEmployeeDto
    {
        ...
        [StringLength(100, ErrorMessage = "Job Title must be between 0 and 100 characters")]
        public string? JobTitle { get; set; }

        [StringLength(100, ErrorMessage = "Job Title (Arabic) must be between 0 and 100 characters")]
